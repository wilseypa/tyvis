#ifndef ENUMERATION_LITERAL_TEST_HH
#define ENUMERATION_LITERAL_TEST_HH
...
class EnumerationLiteralTest : public VHDLDataTest {
  CPPUNIT_TEST_SUITE( EnumerationLiteralTest);
