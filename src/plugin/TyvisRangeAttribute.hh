#ifndef TYVIS_RANGEATTRIBUTE_HH
#define TYVIS_RANGEATTRIBUTE_HH
...
#include "savant/IIRBase_RangeAttribute.hh"

class TyvisRangeAttribute : public virtual TyvisAttribute,
			    public virtual IIRBase_RangeAttribute {
public:
