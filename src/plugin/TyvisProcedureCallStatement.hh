#ifndef TYVIS_PROCEDURECALLSTATEMENT_HH
#define TYVIS_PROCEDURECALLSTATEMENT_HH
...
#include "savant/IIRBase_ProcedureCallStatement.hh"

class TyvisProcedureCallStatement : public virtual TyvisSequentialStatement, public virtual IIRBase_ProcedureCallStatement {
public:
  TyvisProcedureCallStatement();
  ~TyvisProcedureCallStatement();

  void _publish_cc( published_file &_cc_out, PublishData *declarations  );
  void _publish_cc_proc_label( published_file &_cc_out, PublishData *declarations );
  ...
  // Helper Functions
  TyvisAssociationList *    _get_actual_parameter_part();
