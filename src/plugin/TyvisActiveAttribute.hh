#ifndef TYVIS_ACTIVEATTRIBUTE_HH
#define TYVIS_ACTIVEATTRIBUTE_HH
...
#include "savant/IIRBase_ActiveAttribute.hh"

class TyvisActiveAttribute : public virtual TyvisAttribute,
			     public virtual IIRBase_ActiveAttribute {
public:
