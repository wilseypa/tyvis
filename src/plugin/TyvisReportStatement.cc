...
void
TyvisReportStatement::_publish_cc( published_file &_cc_out, PublishData *declarations  ) {
  _publish_cc_assertion_or_report_statement( _cc_out, declarations );
}

void
TyvisReportStatement::_publish_cc_assertion_condition( published_file &_cc_out, PublishData * ) {
  _cc_out << "SAVANT_BOOLEAN_FALSE";
}

void
TyvisReportStatement::_get_list_of_input_signals(  savant::set<Tyvis> *list ){
...
Tyvis *
TyvisReportStatement::_get_report_expression(){ 
  return dynamic_cast<Tyvis *>(get_report_expression());
}

Tyvis *
TyvisReportStatement::_get_severity_expression(){ 
  return dynamic_cast<Tyvis *>(get_severity_expression()); 
}

void
TyvisReportStatement::_build_above_attribute_set(savant::set<TyvisAboveAttribute> *to_build) {
