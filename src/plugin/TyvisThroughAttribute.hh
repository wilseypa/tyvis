#ifndef TYVIS_THROUGHATTRIBUTE_HH
#define TYVIS_THROUGHATTRIBUTE_HH
...
#include "savant/IIRBase_ThroughAttribute.hh"
#include "TyvisAttribute.hh"

class TyvisThroughAttribute : public virtual IIRBase_ThroughAttribute,
