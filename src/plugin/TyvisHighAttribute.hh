#ifndef TYVIS_HIGHATTRIBUTE_HH
#define TYVIS_HIGHATTRIBUTE_HH
...
#include "savant/IIRBase_HighAttribute.hh"

class TyvisHighAttribute : public virtual TyvisAttribute,
			   public virtual IIRBase_HighAttribute {
public:
