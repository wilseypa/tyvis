#ifndef TYVIS_IMAGEATTRIBUTE_HH
#define TYVIS_IMAGEATTRIBUTE_HH
...
#include "savant/IIRBase_ImageAttribute.hh"

class TyvisImageAttribute : public virtual TyvisAttribute,
			    public virtual IIRBase_ImageAttribute {
public:
