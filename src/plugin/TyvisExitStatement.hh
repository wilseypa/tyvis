#ifndef TYVIS_EXITSTATEMENT_HH
#define TYVIS_EXITSTATEMENT_HH
...
#include "savant/IIRBase_ExitStatement.hh"

class TyvisExitStatement : public virtual TyvisSequentialStatement, public virtual IIRBase_ExitStatement {
public:
  ...
  TyvisSequentialStatement       *_get_enclosing_loop();
protected:
