#ifndef TYVIS_LASTEVENTATTRIBUTE_HH
#define TYVIS_LASTEVENTATTRIBUTE_HH
...
#include "savant/IIRBase_LastEventAttribute.hh"

class TyvisLastEventAttribute : public virtual TyvisAttribute, public virtual IIRBase_LastEventAttribute {
public:
