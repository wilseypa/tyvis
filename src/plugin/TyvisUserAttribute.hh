#ifndef TYVIS_USERATTRIBUTE_HH
#define TYVIS_USERATTRIBUTE_HH
...
#include "savant/IIRBase_UserAttribute.hh"

class TyvisUserAttribute : public virtual TyvisAttribute, public virtual IIRBase_UserAttribute {
public:
  ...
  TyvisDeclaration *_build_implicit_declaration( TyvisTextLiteral *decl_name, 
