#ifndef TYVIS_IFSTATEMENT_HH
#define TYVIS_IFSTATEMENT_HH
...
#include "savant/IIRBase_IfStatement.hh"

class TyvisElsif;
class TyvisSequentialStatementList;

class TyvisIfStatement : public virtual TyvisSequentialStatement,
			 public virtual IIRBase_IfStatement {
public:
  TyvisIfStatement();
  ~TyvisIfStatement();
  ...
  TyvisSequentialStatementList *_get_then_sequence();
  TyvisElsif*                   _get_elsif();
  TyvisSequentialStatementList *_get_else_sequence();
