#ifndef TYVIS_POSATTRIBUTE_HH
#define TYVIS_POSATTRIBUTE_HH
...
#include "savant/IIRBase_PosAttribute.hh"

class TyvisPosAttribute : public virtual TyvisAttribute,
			  public virtual IIRBase_PosAttribute {
public:
