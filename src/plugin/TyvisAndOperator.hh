#ifndef TYVIS_ANDOPERATOR_HH
#define TYVIS_ANDOPERATOR_HH
...
#include "savant/IIRBase_AndOperator.hh"

class TyvisAndOperator : public virtual TyvisLogicalOperators, public virtual IIRBase_AndOperator {
public:
