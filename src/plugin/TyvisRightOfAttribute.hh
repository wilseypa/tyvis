#ifndef TYVIS_RIGHTOFATTRIBUTE_HH
#define TYVIS_RIGHTOFATTRIBUTE_HH
...
#include "savant/IIRBase_RightOfAttribute.hh"

class TyvisRightOfAttribute : public virtual TyvisAttribute,
			      public virtual IIRBase_RightOfAttribute {
public:
