#ifndef TYVIS_LOWATTRIBUTE_HH
#define TYVIS_LOWATTRIBUTE_HH
...
#include "savant/IIRBase_LowAttribute.hh"

class TyvisLowAttribute : public virtual TyvisAttribute,
			  public virtual IIRBase_LowAttribute {
public:
