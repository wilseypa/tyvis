#ifndef TYVIS_MONADICOPERATOR_HH
#define TYVIS_MONADICOPERATOR_HH
...
#include "savant/IIRBase_MonadicOperator.hh"

class TyvisMonadicOperator : public virtual TyvisOperator, public virtual IIRBase_MonadicOperator {
public:
