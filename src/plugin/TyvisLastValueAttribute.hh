#ifndef TYVIS_LASTVALUEATTRIBUTE_HH
#define TYVIS_LASTVALUEATTRIBUTE_HH
...
#include "savant/IIRBase_LastValueAttribute.hh"

class TyvisLastValueAttribute : public virtual TyvisAttribute, public virtual IIRBase_LastValueAttribute {
public:
  ...
  void _publish_cc_neccessary_decl_init( published_file &_cc_out, PublishData *declarations );
  void _publish_cc_init_val( published_file &_cc_out, PublishData *declarations );
  ...
  void _publish_cc_init( published_file & ){}  
