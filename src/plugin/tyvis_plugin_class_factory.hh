#ifndef TYVIS_PLUGIN_CLASS_FACTORY_HH
#define TYVIS_PLUGIN_CLASS_FACTORY_HH
...
/** TyVIS implementation of the plugin class factory.  This creates all the TyVIS AIRE nodes */
class tyvis_plugin_class_factory : public plugin_class_factory {
public:
  /**
     Access the singleton object of this class.
  */
  static tyvis_plugin_class_factory *instance();
...
private:
  ...
  virtual ~tyvis_plugin_class_factory();
};
#endif
