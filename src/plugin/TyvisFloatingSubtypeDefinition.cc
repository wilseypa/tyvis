...
TyvisFloatingSubtypeDefinition::_get_resolution_function() {
  return dynamic_cast<TyvisFunctionDeclaration *>(IIRBase_FloatingSubtypeDefinition::get_resolution_function());
}
