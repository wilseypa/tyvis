#ifndef TYVIS_NEXTSTATEMENT_HH
#define TYVIS_NEXTSTATEMENT_HH
...
#include "savant/IIRBase_NextStatement.hh"

class TyvisNextStatement : public virtual TyvisSequentialStatement, public virtual IIRBase_NextStatement {
public:
