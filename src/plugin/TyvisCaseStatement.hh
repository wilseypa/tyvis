#ifndef TYVIS_CASESTATEMENT_HH
#define TYVIS_CASESTATEMENT_HH
...
#include "savant/IIRBase_CaseStatement.hh"

class TyvisCaseStatementAlternativeList;

class TyvisCaseStatement : public virtual TyvisSequentialStatement, public virtual IIRBase_CaseStatement {
public:
  TyvisCaseStatement();
  ~TyvisCaseStatement();
  ...
  TyvisCaseStatementAlternativeList *_get_case_statement_alternatives();
protected:
