#ifndef TYVIS_IDENTIFIER_HH
#define TYVIS_IDENTIFIER_HH
...
#include "savant/IIRBase_Identifier.hh"

class TyvisIdentifier : public virtual TyvisTextLiteral, public virtual IIRBase_Identifier {
public:
