#ifndef TYVIS_OPERATOR_HH
#define TYVIS_OPERATOR_HH
...
#include "savant/IIRBase_Operator.hh"

class TyvisSubprogramDeclaration;

class TyvisOperator : public virtual TyvisExpression, public virtual IIRBase_Operator {
public:
