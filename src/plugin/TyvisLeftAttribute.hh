#ifndef TYVIS_LEFTATTRIBUTE_HH
#define TYVIS_LEFTATTRIBUTE_HH
...
#include "savant/IIRBase_LeftAttribute.hh"

class TyvisLeftAttribute : public virtual TyvisAttribute,
			   public virtual IIRBase_LeftAttribute {
public:
