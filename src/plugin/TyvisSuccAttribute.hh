#ifndef TYVIS_SUCCATTRIBUTE_HH
#define TYVIS_SUCCATTRIBUTE_HH
...
#include "savant/IIRBase_SuccAttribute.hh"

class TyvisSuccAttribute : public virtual TyvisAttribute,
			   public virtual IIRBase_SuccAttribute {
public:
