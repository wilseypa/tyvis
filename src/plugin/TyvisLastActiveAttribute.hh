#ifndef TYVIS_LASTACTIVEATTRIBUTE_HH
#define TYVIS_LASTACTIVEATTRIBUTE_HH
...
#include "savant/IIRBase_LastActiveAttribute.hh"

class TyvisLastActiveAttribute : public virtual TyvisAttribute, public virtual IIRBase_LastActiveAttribute {
public:
