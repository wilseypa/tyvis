#ifndef TYVIS_BASEATTRIBUTE_HH
#define TYVIS_BASEATTRIBUTE_HH
...
#include "savant/IIRBase_BaseAttribute.hh"

class TyvisBaseAttribute : public virtual TyvisAttribute,
