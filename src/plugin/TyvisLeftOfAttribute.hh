#ifndef TYVIS_LEFTOFATTRIBUTE_HH
#define TYVIS_LEFTOFATTRIBUTE_HH
...
#include "savant/IIRBase_LeftOfAttribute.hh"

class TyvisLeftOfAttribute : public virtual TyvisAttribute,
			     public virtual IIRBase_LeftOfAttribute {
public:
