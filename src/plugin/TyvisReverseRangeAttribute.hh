#ifndef TYVIS_REVERSERANGEATTRIBUTE_HH
#define TYVIS_REVERSERANGEATTRIBUTE_HH
...
#include "savant/IIRBase_ReverseRangeAttribute.hh"

class TyvisReverseRangeAttribute : public virtual TyvisAttribute,
				   public virtual IIRBase_ReverseRangeAttribute {
public:
  ...
  IIR_Boolean _is_type_attribute() const;
