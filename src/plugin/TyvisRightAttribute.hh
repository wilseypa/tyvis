#ifndef TYVIS_RIGHTATTRIBUTE_HH
#define TYVIS_RIGHTATTRIBUTE_HH
...
#include "savant/IIRBase_RightAttribute.hh"

class TyvisRightAttribute : public virtual TyvisAttribute,
			    public virtual IIRBase_RightAttribute {
public:
