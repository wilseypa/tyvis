#ifndef TYVIS_WAVEFORMLIST_HH
#define TYVIS_WAVEFORMLIST_HH
...
#include "savant/IIRBase_WaveformList.hh"

class TyvisWaveformList : public virtual TyvisList, public virtual IIRBase_WaveformList {
public:
