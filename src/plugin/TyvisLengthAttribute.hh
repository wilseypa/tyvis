#ifndef TYVIS_LENGTHATTRIBUTE_HH
#define TYVIS_LENGTHATTRIBUTE_HH
...
#include "savant/IIRBase_LengthAttribute.hh"

class TyvisLengthAttribute : public virtual TyvisAttribute,
			     public virtual IIRBase_LengthAttribute {
public:
