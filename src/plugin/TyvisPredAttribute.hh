#ifndef TYVIS_PREDATTRIBUTE_HH
#define TYVIS_PREDATTRIBUTE_HH
...
#include "savant/IIRBase_PredAttribute.hh"

class TyvisPredAttribute : public virtual TyvisAttribute, public virtual IIRBase_PredAttribute {
public:
