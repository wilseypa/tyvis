#ifndef TYVIS_EVENTATTRIBUTE_HH
#define TYVIS_EVENTATTRIBUTE_HH
...
#include "savant/IIRBase_EventAttribute.hh"

class TyvisEventAttribute : public virtual TyvisAttribute, public virtual IIRBase_EventAttribute {
public:
  ...
  void _publish_cc_read_or_write( published_file &, const string &, const string & );
...
private:
  void _publish_cc_state_object_init_last_event( published_file &_cc_out, PublishData *declarations );  
  void _publish_cc_state_object_init_event( published_file &_cc_out, PublishData *declarations );  
  void _publish_cc_state_object_init_attr_var( published_file &_cc_out, Tyvis::SignalAttribute type );
