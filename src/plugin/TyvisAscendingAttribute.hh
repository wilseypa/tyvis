#ifndef TYVIS_ASCENDINGATTRIBUTE_HH
#define TYVIS_ASCENDINGATTRIBUTE_HH
...
#include "savant/IIRBase_AscendingAttribute.hh"

class TyvisAscendingAttribute : public virtual TyvisAttribute,
				public virtual IIRBase_AscendingAttribute {
public:
