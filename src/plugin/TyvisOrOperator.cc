...
const string &
TyvisOrOperator::_get_cc_operator_name() const {
  static const string operator_name = "vhdlOr";
  return operator_name;
}

void
TyvisOrOperator::_publish_cc_ams_operator_name( published_file &_cc_out ) {
  _cc_out << " || ";
}

void
TyvisOrOperator::_publish_cc_xvalue( published_file &_cc_out,
