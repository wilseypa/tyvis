#ifndef TYVIS_TRANSACTIONATTRIBUTE_HH
#define TYVIS_TRANSACTIONATTRIBUTE_HH
...
#include "savant/IIRBase_TransactionAttribute.hh"

class TyvisTransactionAttribute : public virtual TyvisAttribute,
				  public virtual IIRBase_TransactionAttribute {
public:
  ...
  void _publish_cc_read_or_write( published_file &_cc_out,
				  const string &, const string &, PublishData * );
