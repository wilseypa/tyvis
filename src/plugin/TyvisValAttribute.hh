#ifndef TYVIS_VALATTRIBUTE_HH
#define TYVIS_VALATTRIBUTE_HH
...
#include "savant/IIRBase_ValAttribute.hh"

class TyvisValAttribute : public virtual TyvisAttribute,
			  public virtual IIRBase_ValAttribute {
public:
