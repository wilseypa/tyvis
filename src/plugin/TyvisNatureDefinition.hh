#ifndef TYVIS_NATUREDEFINITION_HH
#define TYVIS_NATUREDEFINITION_HH
...
#include "savant/IIRBase_NatureDefinition.hh"

class TyvisNatureDefinition : public virtual TyvisTypeDefinition, public virtual IIRBase_NatureDefinition {
public:
