#ifndef TYVIS_STABLEATTRIBUTE_HH
#define TYVIS_STABLEATTRIBUTE_HH
...
#include "savant/IIRBase_StableAttribute.hh"

class TyvisStableAttribute : public virtual TyvisAttribute,
			     public virtual IIRBase_StableAttribute {
public:
